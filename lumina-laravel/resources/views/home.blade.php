@extends('layouts.app')
@section('title', 'Lumina — AI Beauty Platform')
        ...
        <div class="row align-items-center g-5 py-4">
            <div class="col-lg-6 hero-content fade-in-up">
                ...
                <div class="d-flex flex-wrap gap-3">
                    <a href="{{ route('scan.upload') }}" class="btn btn-lumina btn-lg px-5 pulse-btn">
                        <i class="bi bi-camera me-2"></i>Start Free Scan
                    </a>
                    <a href="{{ route('scan.demo') }}" class="btn btn-outline-lumina btn-lg px-4">
                        Try Demo
                    </a>
                </div>
        ...
        <div class="row g-4 text-center">
            ...
            <div class="col-md-3 fade-in-up">
                <div class="step-card h-100">
                    ...
                    <div class="step-icon mb-3"><i class="bi {{ $step['icon'] }} fs-1 text-lumina-primary"></i></div>
...
<section class="py-5">
    <div class="container">
        <div class="d-flex justify-content-between align-items-center mb-4">
            ...
            <a href="{{ route('products.index') }}" class="btn btn-sm btn-outline-lumina">View All</a>
        </div>
        <div class="row g-3">
            @foreach($categories as $cat)
            <div class="col-6 col-md-3 col-lg-2 fade-in-up">
                <a href="{{ route('products.index', ['category' => $cat->slug]) }}" class="category-card text-decoration-none">
...
<section class="py-5 bg-lumina-soft">
    <div class="container">
        <div class="d-flex justify-content-between align-items-center mb-4">
            ...
            <a href="{{ route('products.index', ['featured'=>1]) }}" class="btn btn-sm btn-outline-lumina">See All</a>
        </div>
        <div class="row g-4">
...
<section class="py-5 membership-cta-section">
    <div class="container">
        <div class="membership-cta-card text-center py-5 px-4 fade-in-up">
            ...
            <a href="{{ route('memberships.index') }}" class="btn btn-lumina btn-lg px-5">
    ...
    <div class="container">
        <div class="row align-items-center g-4">
            <div class="col-md-6 fade-in-up">
                ...
                <a href="{{ route('doctor.landing') }}" class="btn btn-lumina btn-lg">
